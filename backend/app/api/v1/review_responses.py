...
async def get_ai_response_suggestion(review_id: int, current_user=Depends(get_current_active_user)):
    ...
    if rating >= 4:
        suggestions = [
            f"Thank you for your wonderful feedback! I'm glad you were satisfied with the work. Looking forward to collaborating again!",
            f"I really appreciate you taking the time to leave this review. Your kind words motivate me to keep delivering quality work!",
            f"Thank you so much! It was a pleasure working with you on this project.",
        ]
    elif rating >= 3:
        suggestions = [
            f"Thank you for your honest feedback. I value your perspective and will use it to improve my future work.",
            f"I appreciate your review. If there's anything specific I could have done better, I'd love to hear more details.",
        ]
    else:
        suggestions = [
            f"Thank you for your feedback. I take all reviews seriously and will work to address the concerns you've raised.",
            f"I'm sorry the experience didn't meet your expectations. I'd welcome the opportunity to discuss how I can improve.",
        ]
